...
export default function PupukAyam() {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        const response = await fetch('https://simosachi-kambing-default-rtdb.firebaseio.com/pupuk/pupukAyam.json');
        if (!response.ok) {
        ...
        setData(data);
        setIsLoading(false);
        console.log('Data from Firebase Pupuk Ayam:', data);
  ...
  const togglePompa = async () => {
    try {
      ...
      await fetch('https://simosachi-kambing-default-rtdb.firebaseio.com/pupuk/pupukAyam/pompa.json', {
        method: 'PUT',
        headers: {
  ...
  return (
    ...
    >
      <Text style={styles.header}>Monitoring Pupuk Ayam</Text>
      <Image
        source={require('./../assets/src/ayam.jpg')}
        style={styles.image}
      />
      ...
      {isLoading ? (
        ...
        <>
          ...
          <View style={styles.pompaContainer}>
            <Text style={styles.label_button}>Pompa Pupuk Ayam</Text>
