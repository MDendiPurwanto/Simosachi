...
export default function PupukKambing() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await fetch('https://simosachi-kambing-default-rtdb.firebaseio.com/pupukData/pupukKambing.json');
        if (!response.ok) {
        ...
        setData(data);
        setIsLoading(false);
        console.log('Data from Firebase Pupuk Kambing:', data);
  ...
  const togglePompa = async () => {
    try {
      ...
      await fetch('https://simosachi-kambing-default-rtdb.firebaseio.com/pupukData/pupukKambing/pompa.json', {
        method: 'PUT',
        headers: {
  ...
  return (
    ...
    >
      <Text style={styles.header}>Monitoring Pupuk Kambing</Text>
      <Image
        source={require('./../assets/src/kambing.jpg')}
        style={styles.image}
      />
      ...
      {isLoading ? (
        ...
        <>
          ...
          <View style={styles.pompaContainer}>
            <Text style={styles.label_button}>Pompa Pupuk Kambing</Text>
